...
{
	//상수 선언//
	private final int IMAGE = 20;//조각의 수 
	private final int XSIZE = 120;//각 조각의 X축 크기 
	private final int YSIZE = 84;//각 조각의 Y축 크기 
	/////////////
	...
	public void Init()//초기화 함수 
	{
		...
		while(check<1)//시작시 그림 랜덤 배치하도록 
		{
			...
			{
				image[i] = new ImageIcon("3stage_"+(i+1)+".jpg");//이미지 불러오기 
